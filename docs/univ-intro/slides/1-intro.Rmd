...
张桄玮: 中国地质大学(武汉) 计算机学院 学生

-   平平无奇的本科生(下学期大三)
-   像大家一样大的时候写一点小的 VB 游戏
...
-   植物大战僵尸如何[最高效地安排植物](https://www.bilibili.com/video/BV1UL411t71i/)
...
![](images/log-table.png){.center data-external="1" width="45%"}
...
-   屏幕 = 一堆[像素点](http://www.cknuckles.com/rgbsliders.html)$(R,G,B)$
    -   获取输入
...
![](images/majo-no-tabitabi.png){data-external="1"}
...
![](images/malware.png){.float-right data-external="1"}
...
![](images/f12inspect.png){data-external="1" width="518"}
...
![](images/csdn-acpy.png){data-external="1" width="448"}
...
![](images/js-code.png){data-external="1"}
...
![](images/today-inter.png){data-external="1"}

## 计算机的交互历史 (cont'd)

(1980s)一个黑框框

![](images/cliface.png){data-external="1" width="300"}
...
-   回到[Hello world](https://github.com/susam/hello)...
